...
reg     [2:0] basesoc_i2s_next_state;
reg     [2:0] basesoc_i2s_state;
...
reg    [31:0] basesoc_interrupt;
reg           basesoc_litespi_grant;
reg     [3:0] basesoc_litespi_next_state;
wire    [1:0] basesoc_litespi_request;
reg           basesoc_litespi_rx_demux_endpoint0_source_first;
reg           basesoc_litespi_rx_demux_endpoint0_source_last;
reg    [31:0] basesoc_litespi_rx_demux_endpoint0_source_payload_data;
wire          basesoc_litespi_rx_demux_endpoint0_source_ready;
reg           basesoc_litespi_rx_demux_endpoint0_source_valid;
reg           basesoc_litespi_rx_demux_endpoint1_source_first;
reg           basesoc_litespi_rx_demux_endpoint1_source_last;
reg    [31:0] basesoc_litespi_rx_demux_endpoint1_source_payload_data;
wire          basesoc_litespi_rx_demux_endpoint1_source_ready;
reg           basesoc_litespi_rx_demux_endpoint1_source_valid;
...
reg           basesoc_litespi_rx_demux_sink_ready;
wire          basesoc_litespi_rx_demux_sink_valid;
reg     [3:0] basesoc_litespi_state;
...
reg           basesoc_litespi_tx_mux_endpoint0_sink_ready;
...
reg           basesoc_litespi_tx_mux_endpoint1_sink_ready;
wire          basesoc_litespi_tx_mux_endpoint1_sink_valid;
wire          basesoc_litespi_tx_mux_sel;
reg           basesoc_litespi_tx_mux_source_first;
reg           basesoc_litespi_tx_mux_source_last;
reg    [31:0] basesoc_litespi_tx_mux_source_payload_data;
reg     [5:0] basesoc_litespi_tx_mux_source_payload_len;
reg     [7:0] basesoc_litespi_tx_mux_source_payload_mask;
reg     [3:0] basesoc_litespi_tx_mux_source_payload_width;
wire          basesoc_litespi_tx_mux_source_ready;
reg           basesoc_litespi_tx_mux_source_valid;
wire     [1:0] basesoc_litespimmap=1'd0;
reg    [29:0] basesoc_litespimmap_burst_adr;
reg    [29:0] basesoc_litespimmap_burst_adr_litespi_next_value1;
reg           basesoc_litespimmap_burst_adr_litespi_next_value_ce1;
reg           basesoc_litespimmap_burst_cs;
reg           basesoc_litespimmap_burst_cs_litespi_next_value0;
reg           basesoc_litespimmap_burst_cs_litespi_next_value_ce0;
reg           basesoc_litespimmap_bus_ack;
...
reg    [31:0] basesoc_litespimmap_bus_dat_r;
wire   [31:0] basesoc_litespimmap_bus_dat_w;
wire           basesoc_litespimmap_bus_err = 1'd0;
wire    [3:0] basesoc_litespimmap_bus_sel;
wire          basesoc_litespimmap_bus_stb;
wire          basesoc_litespimmap_bus_we;
reg     [8:0] basesoc_litespimmap_count;
reg           basesoc_litespimmap_cs;
wire          basesoc_litespimmap_done;
wire    [31:0] basesoc_litespimmap_dummy= 32'd57005;
reg           basesoc_litespimmap_re;
wire          basesoc_litespimmap_sink_first;
wire          basesoc_litespimmap_sink_last;
wire   [31:0] basesoc_litespimmap_sink_payload_data;
reg           basesoc_litespimmap_sink_ready;
wire          basesoc_litespimmap_sink_valid;
wire           basesoc_litespimmap_source_first = 1'd0;
reg           basesoc_litespimmap_source_last;
reg    [31:0] basesoc_litespimmap_source_payload_data;
reg     [5:0] basesoc_litespimmap_source_payload_len;
reg     [7:0] basesoc_litespimmap_source_payload_mask;
reg     [3:0] basesoc_litespimmap_source_payload_width;
wire          basesoc_litespimmap_source_ready;
reg           basesoc_litespimmap_source_valid;
wire    [7:0] basesoc_litespimmap_spi_dummy_bits;
reg     [7:0] basesoc_litespimmap_storage;
reg           basesoc_litespimmap_wait;
reg     [1:0] basesoc_litespiphy_next_state;
reg     [1:0] basesoc_litespiphy_state;
wire          basesoc_master_cs;
reg           basesoc_master_cs_re;
reg           basesoc_master_cs_storage;
wire    [7:0] basesoc_master_len;
wire    [7:0] basesoc_master_mask;
reg           basesoc_master_phyconfig_re;
reg    [23:0] basesoc_master_phyconfig_storage;
...
reg           basesoc_master_rx_fifo_pipe_valid_source_first;
reg           basesoc_master_rx_fifo_pipe_valid_source_last;
reg    [31:0] basesoc_master_rx_fifo_pipe_valid_source_payload_data;
wire          basesoc_master_rx_fifo_pipe_valid_source_ready;
reg           basesoc_master_rx_fifo_pipe_valid_source_valid;
...
reg           basesoc_master_rxtx_re;
wire   [31:0] basesoc_master_rxtx_w;
reg           basesoc_master_rxtx_we;
...
reg           basesoc_master_status_re;
reg     [1:0] basesoc_master_status_status;
...
reg           basesoc_master_tx_fifo_pipe_valid_source_first;
reg           basesoc_master_tx_fifo_pipe_valid_source_last;
reg    [31:0] basesoc_master_tx_fifo_pipe_valid_source_payload_data;
reg     [5:0] basesoc_master_tx_fifo_pipe_valid_source_payload_len;
reg     [7:0] basesoc_master_tx_fifo_pipe_valid_source_payload_mask;
reg     [3:0] basesoc_master_tx_fifo_pipe_valid_source_payload_width;
wire          basesoc_master_tx_fifo_pipe_valid_source_ready;
reg           basesoc_master_tx_fifo_pipe_valid_source_valid;
wire           basesoc_master_tx_fifo_sink_sink_first=1'd0;
...
wire           basesoc_reset=1'd0;
reg     [1:0] basesoc_spimaster_next_state;
reg     [1:0] basesoc_spimaster_state;
wire    [31:0] basesoc_vexriscv=32'd0;
...
reg           basesoc_we;
reg           basesoc_wishbone2csr_next_state;
reg           basesoc_wishbone2csr_state;
...
wire           basesoc_wishbone_err=1'd0;
wire    [3:0] basesoc_wishbone_sel;
wire          basesoc_wishbone_stb;
wire          basesoc_wishbone_we;
wire          caravelsdrtristateimpl0__i;
reg           caravelsdrtristateimpl0__o;
reg           caravelsdrtristateimpl0_oe;
wire          caravelsdrtristateimpl1__i;
reg           caravelsdrtristateimpl1__o;
reg           caravelsdrtristateimpl1_oe;
wire          caravelsdrtristateimpl2__i;
reg           caravelsdrtristateimpl2__o;
reg           caravelsdrtristateimpl2_oe;
wire          caravelsdrtristateimpl3__i;
reg           caravelsdrtristateimpl3__o;
reg           caravelsdrtristateimpl3_oe;
reg    [29:0] comb_array_muxed0;
reg    [31:0] comb_array_muxed1;
reg     [3:0] comb_array_muxed10;
reg           comb_array_muxed11;
reg           comb_array_muxed12;
reg           comb_array_muxed13;
reg     [2:0] comb_array_muxed14;
reg     [1:0] comb_array_muxed15;
reg    [29:0] comb_array_muxed16;
reg    [31:0] comb_array_muxed17;
reg     [3:0] comb_array_muxed18;
reg           comb_array_muxed19;
reg     [3:0] comb_array_muxed2;
reg           comb_array_muxed20;
reg           comb_array_muxed21;
reg     [2:0] comb_array_muxed22;
reg     [1:0] comb_array_muxed23;
reg    [29:0] comb_array_muxed24;
reg    [31:0] comb_array_muxed25;
reg     [3:0] comb_array_muxed26;
reg           comb_array_muxed27;
reg           comb_array_muxed28;
reg           comb_array_muxed29;
reg           comb_array_muxed3;
reg     [2:0] comb_array_muxed30;
reg     [1:0] comb_array_muxed31;
reg           comb_array_muxed4;
reg           comb_array_muxed5;
reg     [2:0] comb_array_muxed6;
reg     [1:0] comb_array_muxed7;
reg    [29:0] comb_array_muxed8;
reg    [31:0] comb_array_muxed9;
wire   [31:0] counter0;
reg    [31:0] counter1;
wire    [3:0] csr_bankarray_adr;
wire   [12:0] csr_bankarray_csrbank0_edge0_r;
reg           csr_bankarray_csrbank0_edge0_re;
wire   [12:0] csr_bankarray_csrbank0_edge0_w;
reg           csr_bankarray_csrbank0_edge0_we;
...
reg    [31:0] csr_bankarray_interface1_bank_bus_dat_r;
...
reg    [31:0] csr_bankarray_interface2_bank_bus_dat_r;
...
reg    [31:0] csr_bankarray_interface3_bank_bus_dat_r;
...
reg    [31:0] csr_bankarray_interface4_bank_bus_dat_r;
...
reg    [31:0] csr_bankarray_interface7_bank_bus_dat_r;
...
reg     [3:0] decoder0_slave_sel;
reg     [3:0] decoder0_slave_sel_r;
reg     [3:0] decoder1_slave_sel;
reg     [3:0] decoder1_slave_sel_r;
reg     [3:0] decoder2_slave_sel;
reg     [3:0] decoder2_slave_sel_r;
reg     [3:0] decoder3_slave_sel;
reg     [3:0] decoder3_slave_sel_r;
wire           dq_i;
wire          dq_o;
wire          dq_oe;
reg     [3:0] dq_psram_pads_i;
wire    [3:0] dq_psram_pads_o;
wire    [3:0] dq_psram_pads_oe;
reg           gpio_edge_re;
reg    [12:0] gpio_edge_storage;
reg           gpio_enable_re;
reg    [12:0] gpio_enable_storage;
reg           gpio_eventsourceprocess0_clear;
reg           gpio_eventsourceprocess0_pending;
wire          gpio_eventsourceprocess0_status;
reg           gpio_eventsourceprocess0_trigger;
reg           gpio_eventsourceprocess0_trigger_d;
reg           gpio_eventsourceprocess10_clear;
reg           gpio_eventsourceprocess10_pending;
wire          gpio_eventsourceprocess10_status;
reg           gpio_eventsourceprocess10_trigger;
reg           gpio_eventsourceprocess10_trigger_d;
reg           gpio_eventsourceprocess11_clear;
reg           gpio_eventsourceprocess11_pending;
wire          gpio_eventsourceprocess11_status;
reg           gpio_eventsourceprocess11_trigger;
reg           gpio_eventsourceprocess11_trigger_d;
reg           gpio_eventsourceprocess12_clear;
reg           gpio_eventsourceprocess12_pending;
wire          gpio_eventsourceprocess12_status;
reg           gpio_eventsourceprocess12_trigger;
reg           gpio_eventsourceprocess12_trigger_d;
reg           gpio_eventsourceprocess1_clear;
reg           gpio_eventsourceprocess1_pending;
wire          gpio_eventsourceprocess1_status;
reg           gpio_eventsourceprocess1_trigger;
reg           gpio_eventsourceprocess1_trigger_d;
reg           gpio_eventsourceprocess2_clear;
reg           gpio_eventsourceprocess2_pending;
wire          gpio_eventsourceprocess2_status;
reg           gpio_eventsourceprocess2_trigger;
reg           gpio_eventsourceprocess2_trigger_d;
reg           gpio_eventsourceprocess3_clear;
reg           gpio_eventsourceprocess3_pending;
wire          gpio_eventsourceprocess3_status;
reg           gpio_eventsourceprocess3_trigger;
reg           gpio_eventsourceprocess3_trigger_d;
reg           gpio_eventsourceprocess4_clear;
reg           gpio_eventsourceprocess4_pending;
wire          gpio_eventsourceprocess4_status;
reg           gpio_eventsourceprocess4_trigger;
reg           gpio_eventsourceprocess4_trigger_d;
reg           gpio_eventsourceprocess5_clear;
reg           gpio_eventsourceprocess5_pending;
wire          gpio_eventsourceprocess5_status;
reg           gpio_eventsourceprocess5_trigger;
reg           gpio_eventsourceprocess5_trigger_d;
reg           gpio_eventsourceprocess6_clear;
reg           gpio_eventsourceprocess6_pending;
wire          gpio_eventsourceprocess6_status;
reg           gpio_eventsourceprocess6_trigger;
reg           gpio_eventsourceprocess6_trigger_d;
reg           gpio_eventsourceprocess7_clear;
reg           gpio_eventsourceprocess7_pending;
wire          gpio_eventsourceprocess7_status;
reg           gpio_eventsourceprocess7_trigger;
reg           gpio_eventsourceprocess7_trigger_d;
reg           gpio_eventsourceprocess8_clear;
reg           gpio_eventsourceprocess8_pending;
wire          gpio_eventsourceprocess8_status;
reg           gpio_eventsourceprocess8_trigger;
reg           gpio_eventsourceprocess8_trigger_d;
reg           gpio_eventsourceprocess9_clear;
reg           gpio_eventsourceprocess9_pending;
wire          gpio_eventsourceprocess9_status;
reg           gpio_eventsourceprocess9_trigger;
reg           gpio_eventsourceprocess9_trigger_d;
wire          gpio_i00;
wire          gpio_i01;
wire          gpio_i02;
wire          gpio_i10;
...
wire          gpio_i91;
wire          gpio_i92;
reg           gpio_in_pads_n_d0;
reg           gpio_in_pads_n_d1;
reg           gpio_in_pads_n_d10;
reg           gpio_in_pads_n_d11;
reg           gpio_in_pads_n_d12;
reg           gpio_in_pads_n_d2;
reg           gpio_in_pads_n_d3;
reg           gpio_in_pads_n_d4;
reg           gpio_in_pads_n_d5;
reg           gpio_in_pads_n_d6;
reg           gpio_in_pads_n_d7;
reg           gpio_in_pads_n_d8;
reg           gpio_in_pads_n_d9;
reg           gpio_in_re;
reg    [12:0] gpio_in_status;
wire          gpio_in_we;
wire          gpio_irq;
reg           gpio_mode_re;
reg    [12:0] gpio_mode_storage;
reg           gpio_oe_re;
reg    [12:0] gpio_oe_storage;
reg           gpio_out_re;
reg    [12:0] gpio_out_storage;
reg    [12:0] gpio_pads_i;
reg    [12:0] gpio_pads_o;
reg    [12:0] gpio_pads_oe;
reg    [12:0] gpio_pending_r;
reg           gpio_pending_re;
reg    [12:0] gpio_pending_status;
wire          gpio_pending_we;
reg           gpio_status_re;
reg    [12:0] gpio_status_status;
wire          gpio_status_we;
reg           i2c__r_re;
wire           i2c__r_status;
wire          i2c__r_we;
reg           i2c__w_re;
reg     [2:0] i2c__w_storage;
wire          i2c_oe;
wire           i2c_pads_scl_i;
wire          i2c_pads_scl_o;
...
wire          i2c_sda1;
wire          i2s_bus_ack;
reg    [29:0] i2s_bus_adr;
wire     [1:0] i2s_bus_bte=2'd0;
wire     [2:0] i2s_bus_cti=3'd0;
reg           i2s_bus_cyc;
wire   [31:0] i2s_bus_dat_r;
reg    [31:0] i2s_bus_dat_w;
wire          i2s_bus_err;
reg     [3:0] i2s_bus_sel;
reg           i2s_bus_stb;
reg           i2s_bus_we;
wire    [8:0] i2s_capture_depth;
reg           i2s_capture_depth_rx_samples_cnt;
reg           i2s_capture_depth_rx_samples_cnt_next_value0;
reg           i2s_capture_depth_rx_samples_cnt_next_value_ce0;
reg           i2s_clk_conf_re;
reg    [31:0] i2s_clk_conf_storage;
reg           i2s_clk_d;
wire          i2s_clk_pin;
...
reg           i2s_left_rx_ready_clear;
reg           i2s_left_rx_ready_pending;
wire          i2s_left_rx_ready_status;
reg           i2s_left_rx_ready_trigger;
reg    [15:0] i2s_lrck_counter;
wire   [23:0] i2s_lrck_freq;
wire   [15:0] i2s_lrck_period;
wire          i2s_pads_di;
reg           i2s_pads_sck;
reg           i2s_pads_ws;
reg     [1:0] i2s_pending_r;
reg           i2s_pending_re;
reg     [1:0] i2s_pending_status;
wire          i2s_pending_we;
reg           i2s_reset;
wire          i2s_right_rx_ready0;
wire          i2s_right_rx_ready1;
wire          i2s_right_rx_ready2;
reg           i2s_right_rx_ready_clear;
reg           i2s_right_rx_ready_pending;
wire          i2s_right_rx_ready_status;
reg           i2s_right_rx_ready_trigger;
wire          i2s_rising_edge;
reg           i2s_rx_conf_re;
reg    [31:0] i2s_rx_conf_storage;
reg           i2s_rx_ctl_re;
reg    [12:0] i2s_rx_ctl_storage;
reg           i2s_rx_data_left_re;
reg    [31:0] i2s_rx_data_left_status;
reg    [31:0] i2s_rx_data_left_status_i2s_next_value2;
reg           i2s_rx_data_left_status_i2s_next_value_ce2;
wire          i2s_rx_data_left_we;
reg           i2s_rx_data_right_re;
wire    [31:0] i2s_rx_data_right_status=32'd0;
wire          i2s_rx_data_right_we;
reg           i2s_rx_delay_cnt;
reg           i2s_rx_delay_cnt_i2s_next_value3;
reg           i2s_rx_delay_cnt_i2s_next_value_ce3;
reg           i2s_rx_delay_val;
reg           i2s_rx_mem_left_re;
reg    [31:0] i2s_rx_mem_left_storage;
reg           i2s_rx_mem_right_re;
reg    [31:0] i2s_rx_mem_right_storage;
wire          i2s_rx_pin;
reg    [31:0] i2s_rx_wr_addr_left;
reg    [31:0] i2s_rx_wr_addr_left_i2s_next_value0;
reg           i2s_rx_wr_addr_left_i2s_next_value_ce0;
reg    [31:0] i2s_rx_wr_addr_right;
reg    [31:0] i2s_rx_wr_addr_right_i2s_next_value1;
reg           i2s_rx_wr_addr_right_i2s_next_value_ce1;
reg     [5:0] i2s_sample_width;
reg           i2s_sample_width_rx_cnt;
reg           i2s_sample_width_rx_cnt_next_value1;
reg           i2s_sample_width_rx_cnt_next_value_ce1;
reg    [15:0] i2s_sclk_counter;
wire   [15:0] i2s_sclk_period;
reg           i2s_status_re;
reg     [1:0] i2s_status_status;
wire          i2s_status_we;
wire          i2s_sync_pin;
reg           int_rst;
wire          interface0_ack;
...
wire          interface9_stb;
wire          interface9_we;
wire           litespisdrphycore0=1'd0;
wire     [1:0] litespisdrphycore1=2'd0;
wire     [3:0] litespisdrphycore2=4'd0;
wire     [7:0] litespisdrphycore3=8'd0;
reg           litespisdrphycore_clk;
reg     [7:0] litespisdrphycore_cnt;
reg     [3:0] litespisdrphycore_count;
wire          litespisdrphycore_cs;
wire          litespisdrphycore_cs_enable;
wire    [7:0] litespisdrphycore_div;
wire          litespisdrphycore_done;
reg     [3:0] litespisdrphycore_dq_i;
reg     [3:0] litespisdrphycore_dq_o;
wire    [3:0] litespisdrphycore_dq_oe;
reg           litespisdrphycore_en;
wire           litespisdrphycore_en_int=1'd0;
wire          litespisdrphycore_negedge;
wire          litespisdrphycore_posedge;
reg           litespisdrphycore_posedge_reg;
reg           litespisdrphycore_posedge_reg2;
reg           litespisdrphycore_re;
...
reg           litespisdrphycore_sink_ready;
wire          litespisdrphycore_sink_valid;
wire           litespisdrphycore_source_first=1'd0;
reg           litespisdrphycore_source_last;
wire   [31:0] litespisdrphycore_source_payload_data;
wire          litespisdrphycore_source_ready;
reg           litespisdrphycore_source_valid;
wire    [7:0] litespisdrphycore_spi_clk_divisor;
reg     [7:0] litespisdrphycore_sr_cnt;
reg     [7:0] litespisdrphycore_sr_cnt_litespiphy_next_value;
reg           litespisdrphycore_sr_cnt_litespiphy_next_value_ce;
reg    [31:0] litespisdrphycore_sr_in;
reg           litespisdrphycore_sr_in_shift;
reg    [31:0] litespisdrphycore_sr_out;
reg           litespisdrphycore_sr_out_load;
reg           litespisdrphycore_sr_out_shift;
reg     [7:0] litespisdrphycore_storage;
...
wire     [1:0] mgmt_soc_wbm_bte=2'd0;
wire     [2:0] mgmt_soc_wbm_cti=3'd0;
...
reg           pwm0_enable_re;
reg           pwm0_enable_storage;
reg           pwm0_period_re;
reg    [31:0] pwm0_period_storage;
reg           pwm0_width_re;
reg    [31:0] pwm0_width_storage;
wire   [31:0] pwm10_width;
wire          pwm11_enable;
wire   [31:0] pwm12_width;
reg           pwm1_enable_re;
reg           pwm1_enable_storage;
wire           pwm1_reset=1'd0;
reg           pwm1_width_re;
reg    [31:0] pwm1_width_storage;
reg           pwm2_enable_re;
reg           pwm2_enable_storage;
reg           pwm2_width_re;
reg    [31:0] pwm2_width_storage;
wire          pwm3_enable;
reg           pwm3_enable_re;
reg           pwm3_enable_storage;
reg           pwm3_width_re;
reg    [31:0] pwm3_width_storage;
...
reg           spi_master_enable_re;
reg           spi_master_enable_storage;
reg           spi_master_irq0;
...
reg           spi_master_pending_r;
reg           spi_master_pending_re;
reg           spi_master_pending_status;
wire          spi_master_pending_we;
wire          spi_master_sel;
wire          spi_master_spi_xfer_done0;
wire          spi_master_spi_xfer_done1;
wire          spi_master_spi_xfer_done2;
reg           spi_master_spi_xfer_done_clear;
reg           spi_master_spi_xfer_done_pending;
wire          spi_master_spi_xfer_done_status;
wire          spi_master_spi_xfer_done_trigger;
wire          spi_master_start0;
reg           spi_master_start1;
reg           spi_master_status_re0;
reg           spi_master_status_re1;
reg     [1:0] spi_master_status_status0;
reg           spi_master_status_status1;
...
wire          spi_pads_miso;
reg           spi_pads_mosi;
reg           spiflash_pads_clk;
wire          spiflash_pads_cs_n;
wire     [3:0] spiramquad=4'd0;
reg           spiramquad_addr_stage;
reg           spiramquad_bus_ack;
...
wire           spiramquad_bus_err=1'd0;
wire    [3:0] spiramquad_bus_sel;
wire          spiramquad_bus_stb;
wire          spiramquad_bus_we;
reg           spiramquad_clk;
reg     [5:0] spiramquad_counter0;
reg     [5:0] spiramquad_counter1;
reg           spiramquad_cs_n;
reg     [3:0] spiramquad_dq_oe;
reg     [3:0] spiramquad_dqi;
wire    [3:0] spiramquad_i0;
reg           spiramquad_i1;
wire    [3:0] spiramquad_o;
wire    [3:0] spiramquad_oe;
reg    [31:0] spiramquad_sr;
reg           spiramquad_write_stage;
reg           sram_bus_ack;
...
wire          sys_rst;
reg           timer0_en_re;
reg           timer0_en_storage;
reg           timer0_enable_re;
reg           timer0_enable_storage;
wire          timer0_irq;
reg           timer0_load_re;
reg    [31:0] timer0_load_storage;
reg           timer0_pending_r;
reg           timer0_pending_re;
reg           timer0_pending_status;
wire          timer0_pending_we;
reg           timer0_reload_re;
reg    [31:0] timer0_reload_storage;
reg           timer0_status_re;
reg           timer0_status_status;
wire          timer0_status_we;
reg           timer0_update_value_re;
reg           timer0_update_value_storage;
reg    [31:0] timer0_value;
reg           timer0_value_re;
reg    [31:0] timer0_value_status;
wire          timer0_value_we;
wire          timer0_zero0;
wire          timer0_zero1;
wire          timer0_zero2;
reg           timer0_zero_clear;
reg           timer0_zero_pending;
wire          timer0_zero_status;
wire          timer0_zero_trigger;
reg           timer0_zero_trigger_d;
reg           timer1_en_re;
reg           timer1_en_storage;
reg           timer1_enable_re;
reg           timer1_enable_storage;
wire          timer1_irq;
reg           timer1_load_re;
reg    [31:0] timer1_load_storage;
reg           timer1_pending_r;
reg           timer1_pending_re;
reg           timer1_pending_status;
wire          timer1_pending_we;
reg           timer1_reload_re;
reg    [31:0] timer1_reload_storage;
reg           timer1_status_re;
reg           timer1_status_status;
wire          timer1_status_we;
reg           timer1_update_value_re;
reg           timer1_update_value_storage;
reg    [31:0] timer1_value;
reg           timer1_value_re;
reg    [31:0] timer1_value_status;
wire          timer1_value_we;
wire          timer1_zero0;
wire          timer1_zero1;
wire          timer1_zero2;
reg           timer1_zero_clear;
reg           timer1_zero_pending;
wire          timer1_zero_status;
wire          timer1_zero_trigger;
reg           timer1_zero_trigger_d;
wire           tstriple0_i;
wire          tstriple0_o;
wire          tstriple0_oe;
wire           tstriple1_i;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-12-10 11:19:04.
//------------------------------------------------------------------------------
